...
; 1. Welcome Page
; Yummi: keep the page registered for MUI compatibility, but never show it.
...
; Yummi uses the currentUser default install directory and does not prompt for a path.
!define MUI_PAGE_CUSTOMFUNCTION_PRE Skip
!insertmacro MUI_PAGE_DIRECTORY

; 6. Start menu shortcut page
; Yummi: preserve MUI start-menu bookkeeping, but never ask the user for a folder.
...
; 8. Finish page
; Yummi: the post-install hook launches the Agent and auto-closes the progress window.
; Keep the MUI page registered, but always skip it so there is no Finish/Run click.
!define MUI_PAGE_CUSTOMFUNCTION_PRE Skip
